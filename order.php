    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="email" name="email" placeholder="bca@gmail.com" class="input-responsive" required>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($res2 == true) {
                ...
                $_SESSION['order'] = "<div class='success1 text-center'>Food Ordered Successfully.</div>";
                header('location:' . SITEURL);
            } else {
                //Failed to Save Order
                $_SESSION['order'] = "<div class='error1 text-center'>Failed to Order Food.</div>";
                header('location:' . SITEURL);
            }
